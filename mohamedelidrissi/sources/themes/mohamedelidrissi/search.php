...
?>
 ...
 <title> نتائج البحث المتعلقة ب "<?php the_search_query();?>" </title>

       <h1 class="title-search"> نتائج البحث المتعلقة ب "<?php the_search_query();?>" </h1>
      ...
      <style>
          ...
          @media screen and (max-width:800px) {
           ...
           <div class="blog-container">
            ...
            <?php  } else : ?>
                <h1 class="title-search">! لا توجد </h1>
                <?php endif;?>
